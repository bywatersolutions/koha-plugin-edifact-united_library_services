...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices;
use Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact::Order
        ->new(
        {
